...
private:
    ...
    std::map<SDL_Keycode, std::size_t> key_map{
        {SDLK_KP_0, 0x0},      {SDLK_KP_1, 0x1},        {SDLK_KP_2, 0x2},     {SDLK_KP_3, 0x3},
        {SDLK_KP_4, 0x4},      {SDLK_KP_5, 0x5},        {SDLK_KP_6, 0x6},     {SDLK_KP_7, 0x7},
        {SDLK_KP_8, 0x8},      {SDLK_KP_9, 0x9},        {SDLK_RIGHT, 0xA},    {SDLK_KP_PERIOD, 0xB},
